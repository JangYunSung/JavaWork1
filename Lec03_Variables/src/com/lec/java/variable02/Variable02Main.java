...
public class Variable02Main {
	...
	byte num1 = -128; //노란색 줄은 사용하지않은것을 사용할때 나온다
	byte num2 = 0;
	byte num3 = 123;
//	byte num4 = 1234; // 에러 : byte 에 저장할수 있는 크기를 넘어섬
...
//	long num10 = 9876543210; //  The literal 9876543210 of type int is out of range 
	...
	// 실수리터럴 --> double 로 형변환 하려한다. 
	// "~" 리터럴 --> 문자열(String) 로 형변환 하려한다.
	// ...
	
	long num11 = 987654321000000000L; // L <-long 형리터럴
	long num12 = 12;   //4바이트 12 
	long num13 = 12L;  //8바이트 12
	int num14 = 12;
//	int num15 = 12L; // long 타입은 int 에 대입 불가 
	// 큰사이즈를 작은사이즈에 대입불가
	
	// 값의 경계선
	byte num15 = Byte.MAX_VALUE; // 127
	byte num16 = (byte)(num15 - 256) ;
	byte num17 = (byte)(num15 + 1) ;
