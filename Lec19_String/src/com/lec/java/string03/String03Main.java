...
/*  StringBuffer, StringBuilder
	 ...
	 String 클래스는 immutable 클래스이고, //변할수 없는
...
public class String03Main {
	...
	public static void main(String[] args) {
		...
		System.out.println(str1.concat("Java")); // String 객체의 메소드 concat
		System.out.println(str1); // str1 이 실제 변경되지 않는다
		...
		if (str1 == str2) {
			...
			System.out.println("==다른 참조"); // 항상 새로운 객체를 만든다
		}
