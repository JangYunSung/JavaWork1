...
public class String01Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("str1 길이 : " + str1.length());  // 문자의 개수
		System.out.println("str2 길이 : " + str2.length());  // 문자의 개수
		...
		str1 = str1.concat(str2);  //변경하려면 이와같이 덮어쓰기 해야한다.
...
//		System.out.println(str1.charAt(20));  StringIndexOutOfBoundsException
		...
		System.out.println(str8.substring(2,5)); //인덱스 2부터 5까지
