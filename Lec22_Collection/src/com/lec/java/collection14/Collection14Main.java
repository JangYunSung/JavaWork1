...
public class Collection14Main {
	...
	public static void main(String[] args) throws ParseException {
		...
		Collections.sort(list3, new Asc()); //이름 오름차수
		System.out.println(list3);
		System.out.println("Comparator<> 적용");
		Collections.sort(list3, new Desc()); //이름 오름차수
		System.out.println(list3);
		...
		// min(), max()
		// Comparable 메소드 영향 받음  !! 중요 안되있으면 작동안됨
		System.out.println();
...
// Student 를 이름(name) 으로 정령해줄수 있는 Comparator<> 제공
