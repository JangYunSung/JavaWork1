...
public class Class01Main {
	...
	public static void main(String[] args) {
		...
		MyTV tv1 = new MyTV(); //MyTV 인스턴스 생성
		tv1.displayStatus();
		//tv 켜기
		tv1.PowerOnOff();
		//볼륨 조정
...
//		tv1.channel = 100;
		...
		MyTV tv2 = new MyTV(); //MyTV 인스턴스 생성
		tv2.PowerOnOff();
		tv2.channelUp();
		tv2.volumeUp();
		tv2.displayStatus();
		...
		System.out.println();
		tv1 = tv2; 	//
					// 원래 tv1이 레퍼런싱 하더 인스턴스는 Garbage Collector 에 의해 소멸된다. (GC된다)
		tv1.displayStatus();
		tv1.PowerOnOff();
		tv2.displayStatus(); //tv1 과 tv2는 같은 인스턴스를 레퍼런싱 하고있다!!
		System.out.println(tv1);
		System.out.println(tv2);
